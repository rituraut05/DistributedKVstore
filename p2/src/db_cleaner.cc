...
int main(void)
{
    ...
    leveldb::Status pmetadata_status = leveldb::DB::Open(options, "/tmp/pmetadata" + to_string(1), &pmetadata);
    leveldb::Status plogs_status = leveldb::DB::Open(options, "/tmp/plogs" + to_string(1), &plogs);
